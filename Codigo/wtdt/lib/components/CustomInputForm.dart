        ...
        children: <Widget>[
          TextFormField(
            ...
            decoration: InputDecoration(
                ...
                enabledBorder: boderStyles
                    .getUnderlineBorderInputWithBorderSideAndBorderRadius(
                        primaryColor, 5.0, 10.0),
                focusedBorder: boderStyles
                    .getUnderlineBorderInputWithBorderSideAndBorderRadius(
                        primaryColor, 10.0, 10.0)),
            cursorColor: primaryColor,
            validator: (value) {
              if (value == null || value.isEmpty) {
                return 'Favor, informar algum testo';
              }
              return null;
            },
          ),
